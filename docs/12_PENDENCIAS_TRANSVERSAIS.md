...
| Exposição fundamentalista `E`, ADTV, turnover e construção da carteira | Fase 3 e `04_PROTOCOLO_BACKTEST.md` | parâmetros ainda não devidos; devem ser fixados sem olhar o holdout |
| H2–H5, CEPEA, futuros B3, CAR e demais robustezes | Fases 4–5 e `05_SUITE_ROBUSTEZ.md` | extensões/testes futuros já localizados |
