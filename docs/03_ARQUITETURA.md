...
| C7 robustez · C8 report | `backtest/holdout_spec.py`, `scripts/run_holdout_once.py` | 🟡 | pacote H′ de D-068–D-071 pré-registrado até o preflight: um confirmatório, H4/H5 como vetos e sensibilidades descritivas. Inputs H4/H5 presentes; falta somente emissão indivisível antes da Fase 6; relatório na Fase 7 |
