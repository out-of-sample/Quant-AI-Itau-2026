...
| C7 robustez · C8 report | `backtest/holdout_spec.py`, `scripts/run_holdout_once.py` | 🟡 | pacote H′ de D-068/D-069 pré-registrado até o preflight: um confirmatório, H4/H5 como vetos e sensibilidades descritivas. Controle H4 presente; faltam placebo geográfico H5 e emissão indivisível antes da Fase 6; relatório na Fase 7 |
