...
futura, ficam em `docs/history/pending.md`. Os dois registros se referenciam sem duplicar
...
**Data**: 2026-07-13
Escolhida entre 21 teses candidatas avaliadas (`docs/history/ideation/candidate-theses.md`), por
...
preço sobe" vale uniformemente. Três exceções confirmadas (`docs/methodology/climate-signal.md`):
...
**Data**: 2026-07-15
Verificação ao vivo de duas fontes gratuitas de proventos (detalhes em `docs/methodology/data.md` §4.2.1):
...
`docs/history/audits/ingestion.md`.
...
A auditoria das três pendências de `docs/methodology/data.md §7` alterou o desenho antes de qualquer retorno
de estratégia:
...
`docs/history/audits/exposures.md` e no registro versionado consumido pelo código.
...
as fontes estão em `docs/history/audits/exposures.md`; o registro consumido pelo código está em
...
protocolo está em `docs/history/audits/corporate-channels.md` e exige:
...
A auditoria PIT dos quatro nomes (protocolo `docs/history/audits/corporate-channels.md`) foi
...
fonte primária** antes de qualquer citação no relatório (regra do `docs/references.md`). (d) O contrato
