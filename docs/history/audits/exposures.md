...
`docs/history/audits/corporate-channels.md`.
...
A auditoria da Fase 3.1 (`docs/history/audits/corporate-channels.md` §9;
...
descartada; produtor ainda fino; canal do processador ainda de preço) em `docs/history/decisions.md`
D-061.
