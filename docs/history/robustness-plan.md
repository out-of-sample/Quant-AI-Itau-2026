...
**Problema confirmado empiricamente** (ver `docs/methodology/data.md`): NASA POWER e ERA5 **sobrescrevem
...
| **Poucos eventos** | 1 safra/ano; o sinal começa em 2015/16 e H1a em 2017/18. O N independente é menor que o sugerido pelo painel UF×cultura | computar e reportar o N efetivo **por teste**; é a limitação nº 1 do projeto (ver `docs/history/adversarial-review.md`) |
