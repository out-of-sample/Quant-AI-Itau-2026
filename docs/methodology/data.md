...
diretamente o quanto a revisão contamina o sinal (`docs/history/robustness-plan.md` §2.4) — em vez de
...
confundidor macro mais óbvio da tese (`docs/history/adversarial-review.md` §4).
...
(ver `docs/history/preregistration.md` §3.3): *o choque climático prevê a revisão que a CONAB vai
publicar?*
...
vetos estão em `docs/history/audits/exposures.md` e
